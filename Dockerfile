...
#   - Ex: docker.io/hexpm/elixir:1.16.1-erlang-26.2.5.14-debian-bookworm-20251020-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/blockster_v2 ./
