...
// Phase 1 mobile SFA hook — replaces modal on mobile UAs (modal hook
// short-circuits in mounted() when isMobileUA() is true).
import { Web3AuthSfa } from "./hooks/web3auth_sfa_hook.js";
