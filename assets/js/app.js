...
let MobileNavHighlight = {
  ...
  updateActiveNav() {
    ...
    const sectionPaths = ['/hubs', '/hub', '/shop', '/airdrop', '/play', '/plinko', '/bankroll', '/members', '/login', '/admin'];
    ...
    links.forEach(link => {
      ...
      if (navPath === '/') {
        ...
        // Play nav: active for /play, /plinko, /bankroll
        isActive = currentPath === '/play' || currentPath.startsWith('/play/') || currentPath.startsWith('/plinko') || currentPath.startsWith('/bankroll');
      } else {
  ...
  updateActiveNav() {
    ...
    links.forEach(link => {
      ...
      if (navPath === '/') {
        ...
        const knownSections = ['/hubs', '/hub/', '/shop', '/airdrop', '/play', '/plinko', '/bankroll', '/login', '/members', '/admin'];
