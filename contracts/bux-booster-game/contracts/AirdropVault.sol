...
/**
 * @title AirdropVault
 * @notice On-chain provably fair airdrop vault for BUX token redemptions
 ...
 *      All dependencies flattened for easier verification on RogueScan.
 *
 * LIFECYCLE:
 * 1. Owner calls startRound(commitmentHash, endTime) — publishes hash before deposits
 * 2. Owner calls depositFor() on behalf of users — records position blocks
...
contract AirdropVault is Initializable, ContextUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
