/**
 * Deploy BuxBoosterGame V6 using curl to bypass hardhat and see raw errors
 */
...
async function main() {
  ...
  const deployTx = await BuxContract.getDeployTransaction({
    gasLimit: 5000000,
    gasPrice: 1000000000000n,  // 1000 gwei legacy
    nonce: nonce,
  ...
  // Save to temp file
  const tmpFile = "/tmp/deploy_v6_payload.json";
