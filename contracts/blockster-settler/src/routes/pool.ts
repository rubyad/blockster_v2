...
router.post("/build-deposit-sol", async (req: Request, res: Response) => {
  try {
    ...
    const tx = await buildDepositSolTx(wallet, amount);
    res.json({ transaction: tx, wallet, amount });
  } catch (err: any) {
...
router.post("/build-deposit-bux", async (req: Request, res: Response) => {
  try {
    ...
    const tx = await buildDepositBuxTx(wallet, amount);
    res.json({ transaction: tx, wallet, amount });
  } catch (err: any) {
...
router.post("/build-withdraw-bux", async (req: Request, res: Response) => {
  try {
    ...
    const tx = await buildWithdrawBuxTx(wallet, lpAmount);
    res.json({ transaction: tx, wallet, lpAmount });
  } catch (err: any) {
