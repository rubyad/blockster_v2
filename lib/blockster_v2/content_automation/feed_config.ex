defmodule BlocksterV2.ContentAutomation.FeedConfig do
  ...
  @feeds [
    ...
    %{source: "Solana Foundation", url: "https://solana.com/news/rss.xml", tier: :premium, status: :active},
    %{source: "Helius Blog", url: "https://www.helius.dev/blog/rss.xml", tier: :premium, status: :active},
    %{source: "marginfi (Solana)", url: "https://medium.com/feed/marginfi", tier: :standard, status: :active},
