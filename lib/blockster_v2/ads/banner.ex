defmodule BlocksterV2.Ads.Banner do
  ...
  @valid_templates ~w(image follow_bar dark_gradient portrait split_card luxury_watch luxury_watch_compact_full luxury_watch_skyscraper luxury_watch_banner luxury_watch_split luxury_car luxury_car_skyscraper luxury_car_banner jet_card_compact jet_card_skyscraper streaming_trial patriotic_portrait patriotic_loop trump_2028_loop fateswap_combined fateswap_kinetic)
