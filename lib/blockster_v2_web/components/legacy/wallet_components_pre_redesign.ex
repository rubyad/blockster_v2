defmodule BlocksterV2Web.Legacy.WalletComponentsPreRedesign do
  @moduledoc """
  @deprecated Pre-redesign wallet components. Preserved for reference.
  Replaced by the redesigned `BlocksterV2Web.WalletComponents` in Wave 5 Page #15.
  """
