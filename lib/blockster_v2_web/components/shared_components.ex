defmodule BlocksterV2Web.SharedComponents do
  ...
  Contains reusable components like header and footer.
  """
  use Phoenix.Component
  use BlocksterV2Web, :verified_routes

  @doc """
  Renders the main site header/navigation.
  """
  ...
  def site_header(assigns) do
    ...
    <div class="fixed top-0 left-0 right-0 w-full z-50 bg-white shadow-sm">
      <!-- Desktop Header -->
        ...
        <div class="flex gap-2 bg-white p-2 rounded-[85px] justify-between w-full border border-[#E8EAEC]">
          ...
          <div class="right-outer flex items-center gap-2 w-1/4 justify-end">
            <%= if @current_user do %>
              ...
              <div class="flex items-center gap-2 rounded-[100px] bg-bg-light py-2 pl-2 pr-4">
                ...
                <div class="flex flex-col justify-center gap-0.5">
                  ...
                  <span class="relative h-1.5 w-full rounded-full bg-white border-[#0000001F] border-[0.5px] overflow-hidden flex">
                    <span class="h-1 bg-[#223436] rounded-full absolute top-0 left-0" style="width: 56%"></span>
                  </span>
                </div>
              </div>
            <% else %>
              <!-- Connect wallet button -->
              <button class="flex items-center gap-1.5 bg-gradient-to-r from-[#8AE388] to-[#BAF55F] rounded-[100px] px-6 py-3 hover:shadow-lg transition-all">
      ...
      <div class="no-search-wrapper flex justify-between items-center">
        <div>
          <.link navigate={~p"/"}>
            <img src="/images/Logo.png" alt="Blockster" />
          </.link>
        ...
        <div class="flex gap-2 items-center">
          ...
          <%= if @current_user do %>
            ...
            <button class="flex items-center gap-2 rounded-[100px] bg-bg-light py-1 pl-1 pr-1 shadow-sm">
          ...
          <% else %>
            ...
            <button class="flex items-center gap-1.5 bg-gradient-to-r from-[#8AE388] to-[#BAF55F] rounded-[100px] px-3 py-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <div class="flex gap-2">
              ...
              />
              <button class="px-4 py-2 bg-white text-[#141414] font-haas_bold_75 rounded-[100px] text-sm hover:bg-[#E8EAEC] transition-colors">
                →
              </button>
            </div>
          </div>
