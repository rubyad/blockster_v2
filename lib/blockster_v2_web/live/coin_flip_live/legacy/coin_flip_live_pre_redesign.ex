defmodule BlocksterV2Web.CoinFlipLive.Legacy.PreRedesign do
  @moduledoc """
  @deprecated Pre-redesign coin flip LiveView. Preserved at
  legacy/coin_flip_live_pre_redesign.ex. The active module is
  BlocksterV2Web.CoinFlipLive.
  """
