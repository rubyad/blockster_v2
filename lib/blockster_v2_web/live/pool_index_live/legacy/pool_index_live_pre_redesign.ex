defmodule BlocksterV2Web.PoolIndexLive.Legacy.PreRedesign do
  @moduledoc """
  Pre-redesign snapshot of `PoolIndexLive`, kept for reference. No longer
  routed. Do not import or call — the module compiles only to preserve the
  original markup for comparison during the existing-pages redesign release.
  """
