defmodule BlocksterV2Web.AirdropLive.Legacy.PreRedesign do
  @moduledoc """
  Pre-redesign snapshot of `BlocksterV2Web.AirdropLive`. Preserved verbatim
  for reference; not routed. The active module lives at
