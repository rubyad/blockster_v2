defmodule BlocksterV2Web.HubLive.Legacy.IndexPreRedesign do
  @moduledoc """
  @deprecated Pre-redesign hubs index. Preserved at legacy/index_pre_redesign.ex.
  The active module is HubLive.Index.
  """
