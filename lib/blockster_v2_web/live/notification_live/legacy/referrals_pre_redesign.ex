defmodule BlocksterV2Web.NotificationLive.Legacy.ReferralsPreRedesign do
  @moduledoc """
  @deprecated Legacy referral dashboard — preserved for reference.
  Replaced by the redesigned NotificationLive.Referrals in Wave 6.
  """
