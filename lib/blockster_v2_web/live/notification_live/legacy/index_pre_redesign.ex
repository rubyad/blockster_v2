defmodule BlocksterV2Web.NotificationLive.Legacy.IndexPreRedesign do
  @moduledoc """
  @deprecated Legacy notification index page — preserved for reference.
  Replaced by the redesigned NotificationLive.Index in Wave 6.
  """
