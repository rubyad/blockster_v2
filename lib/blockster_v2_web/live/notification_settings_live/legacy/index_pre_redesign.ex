defmodule BlocksterV2Web.NotificationSettingsLive.Legacy.IndexPreRedesign do
  @moduledoc """
  @deprecated Legacy notification settings page — preserved for reference.
  Replaced by the redesigned NotificationSettingsLive.Index in Wave 6.
  """
