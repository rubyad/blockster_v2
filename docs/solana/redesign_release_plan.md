...
| 4 | Product detail | 🔧 Built, awaiting commit | — | Full template rewrite. Gallery + sticky buy panel + BUX redemption card + related products. 31 new tests. 0 new failures vs baseline. |
| 4–6 | Cart, Checkout, Wallet, Category, Tag, Notifications, Onboarding | ⬜ Not started | — | Cart (#13) is next. |
